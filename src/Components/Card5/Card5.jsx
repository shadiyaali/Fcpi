...
const Card5 = () => {
  ...
  <p className="text-black text-start text-[38px] not-italic font-semibold leading-[normal]" >
    ...
    <button className="inline-flex  justify-center items-center gap-[10px] shrink-0 px-[32px] py-[14px] rounded-[105px] bg-[#00549a]">  
      <p className="text-white text-[14px] not-italic font-semibold leading-[normal]"  >View all</p>
          ...
          {/* <div className="relative"> */}
                        <p className="text-white text-start pl-12 pt-14 text-[67px] not-italic font-medium leading-[normal]"  >3000+</p>
                        <div className="flex text-start pl-14">
                            <p className="text-white text-[17px] not-italic font-normal leading-[normal]"  >Members </p>
                            <p className="text-[#78B6E9] text-[17px] pl-2 not-italic font-normal leading-[normal]"  >use our</p>
                           
                        <img src={Logo23} alt="Image" className="absolute right-0 top-18 transform -translate-y-1/2 " />
                        
                        </div>
                        <p className="text-[#78B6E9] pl-14 text-start text-[17px] not-italic font-normal leading-[normal]"  > educational programs</p>
