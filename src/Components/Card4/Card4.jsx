...
const Card4 = () => {
            ...
            <div className="container">
                <div className=" ">
                    <div className=" bg-[#00549A] rounded-[30px] p-12">
                        <p className="text-white text-start text-[32px] not-italic font-semibold leading-normal"  >Explore FCPI</p>
                        <div className="flex pt-8 ">
                            <p className="text-[#FFF] text-[17px] text-start not-italic font-normal leading-[26px]"  >The standard chunk of Lorem Ipsum used since the 1500s is <br /> reproduced below for those interested. Sections 1.10.32 and <br />1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are<br /> also

                            </p>
                            <p className="text-[#FFF]  text-[17px] pl-24 text-start not-italic font-normal   leading-[26px]" >There are many variations of passages of Lorem Ipsum<br /> available, but the majority have suffered alteration in some<br /> form, by injected humour, or randomised words which don't<br /> look even
  ...
  " >Latest Blogs</p>
                                ...
                                <p className="text-[#222] text-start p-8 text-[21px] not-italic font-semibold leading-[normal]"  >How Refine Labs rewrote the<br />
                                    book on culture</p>
                                ...
                                <div className="inline-flex items-center p-8">
                                    ...
                                    <p className="text-[#58585A] pl-3 text-[14px] not-italic font-semibold leading-[normal]"  >Samuel Gordalina</p>
                                    <p className="text-[#58585A] pl-32 text-[12px] not-italic font-normal leading-[normal]"  >Dec 19, 2022</p>
                                </div>
