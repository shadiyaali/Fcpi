            ...
            <div className=" flex gap-6">
                    <div className=" justify-center rounded-[30px] bg-[#00549a]">
                        <div className="flex pl-5 rounded-[30px]">
                            <div className="pt-6">
                                <button className="justify-center items-center px-7 py-3 rounded-[105px] bg-[#1ab78d]" style={{ width: "auto" }}>
                        ...
                        <div className=" relative flex justify-center p-6 pb-6 pt-6 items-center">
                            <img src={Logo5} alt="Logo" className="rounded-[30px]" />
                             
                            <div className="absolute -right-6 top-1/2 transform -translate-y-1/2">
        <img src={rightArrowImage} alt="Right Arrow" className="rounded-[30px]" />
    </div>
