            ...
            <div className="container">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="bg-[#C5E5FF] rounded-[30px]">
                        ...
                        <p className="text-[#222] p-4 text-start pl-8 text-[21px] not-italic font-medium leading-[normal]"  >Infectious Diseases Forum</p>
                    </div>
                    <div className="bg-[#C5E5FF] rounded-[30px]">
                        <div className="relative">
                        ...
                        <p className="text-[#222] p-4 text-start pl-8 text-[21px] not-italic font-medium leading-[normal]"  >Critical Care Medicine Forum</p>
                    </div>
                    <div className="bg-[#C5E5FF] rounded-[30px]">
                        <div className="relative">
                            <img src={Logo17} alt="Logo" className="w-full rounded-[30px]" />
