...
const About = () => {
 ...
 <div className="pt-10 text-left ">
  ...
  <p className="text-[#00549A] text-[18px] not-italic font-semibold leading-[normal]" >Load more</p>
