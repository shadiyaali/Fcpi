    ...
    {isAboutDropdownHovered && (
        ...
        >
            <ul className="drop-menu">
              ...
              <Link
                    to="/speciality-forum"
                    className={`justify-center items-center px-11 py-[16px] rounded-[105px] bg-${location.pathname.includes('/speciality-forum') ? '[#00549A]' : 'white'} text-${location.pathname.includes('/speciality-forum') ? 'white' : 'black'} hover:bg-[#00549a] hover:text-white`}
                >
                    <div>
